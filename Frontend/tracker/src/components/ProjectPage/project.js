...
// 	const {serialId, id, projectName, createdAt} = siteData
...
// 				<div className='projects-div border d-flex flex-column justify-content-center p-3'>
// 					<button onClick={toDelete} className='trash-icon align-self-end'><FaTrashAlt /></button>
