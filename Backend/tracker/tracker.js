...
app.post('/projects/:id/tasks', authenticateToken, async(request, response)=> {
	const {id} = request.params;
	const {userId} = request;
...
app.get('/projects/:projectId/tasks/:taskId', authenticateToken, async(request, response)=> {
...
app.put('/projects/:projectId/tasks/:taskId', authenticateToken, async(request, response)=> {
	const {projectId, taskId} = request.params
...
app.delete('/projects/:projectId/tasks/:taskId', authenticateToken, async(request, response)=> {
	const {projectId, taskId} = request.params;
	const {userId} = request
